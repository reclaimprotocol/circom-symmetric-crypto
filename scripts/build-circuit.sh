...
#snarkjs zkey beacon resources/circuit_0000.zkey resources/circuit_final.zkey $(curl https://drand.cloudflare.com/public/latest | jq -r ".randomness") 20 -n="Final Beacon phase2"
snarkjs zkey beacon resources/circuit_0000.zkey resources/circuit_final.zkey $(openssl rand -hex 128) 20 -n="Final Beacon phase2"
